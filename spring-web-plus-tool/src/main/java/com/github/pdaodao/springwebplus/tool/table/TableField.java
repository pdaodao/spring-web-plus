...
public class TableField implements Serializable, Cloneable, Comparable<TableField> {
    ...
    public static TableField of(final Column column) {
        final TableField r = new TableField();
     ...
     * @return
     */
    public boolean diff(final TableField info, boolean ignoreName) {
        // 字段名称不同
    ...
    public static TableField of(final String name, final DataType dataType){
    ...
    @Override
    protected TableField clone() {
        final TableField t = new TableField();
