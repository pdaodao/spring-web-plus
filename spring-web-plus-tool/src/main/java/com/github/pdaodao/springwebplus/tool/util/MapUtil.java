...
//		return equals(obj1, obj2, ListUtil.toList(keys));
//	}
//
...
//					if (StrUtil.isEmpty(p2) || !p2.contains(":")) {
//						kvs.put(p1, p2);
//						i += 2;
//						continue;
...
//		return pivot(datas, ListUtil.toList(pks), ListUtil.toList(classKeys), ListUtil.toList(valueKeys));
//	}
//
//	/**
//	 * 行转列
...
//		List<String> pks = ListUtil.toList(pk.trim().split(","));
//		List<String> classKeys = ListUtil.toList(classKey.trim().split(","));
//		List<String> valueKeys = ListUtil.toList(valueKey.trim().split(","));
