insert into sys_user(id, username, salt, password, nickname) values ('1', 'admin', 'sa', '286643d82634d8b70fd5ac03c2a4500db62a17f94a9c30787708e34795d97423','管理员');
...
INSERT INTO sys_menu(id,name,pid,type,id_code, route_url, component_path ,
 route_redirect,icon, seq,is_show,is_cache,enabled)
VALUES ('1102', '角色管理', '11', 2, 'sys:role:list', '/system/role', 'system/role/index', NULL, 'local-role', 2, 1, 1, 1);
